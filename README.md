...
- **After**: 5개 완전한 표 제공 (일반석, 중거리, 장거리, 프리미엄 이코노미 V/W, 프레스티지석 (비즈니스: C / D,I,R))
...
| **시점별 구분** | ❌ 없음 | ✅ 있음 | ✅ 완벽 |
| **클래스별 구분** | ❌ 없음 | △ 일부 | ✅ 완전 |
| **지역/노선별 정보** | ❌ 없음 | △ 일부 |  △ 일부 누락|
| **사용자 추가 검색 필요** | ❌ 필요 | △ 일부 필요 | ✅ 일부 필요 |
...
```bash
git clone https://github.com/hwijae-Jang/RAG_Chatbot_v2.git
cd RAG_Chatbot
